...
export const productInputSchema = z.object({
  ...
  nameFr: z.string().trim().max(120),
  summaryFr: z.string().trim().max(400),
  bodyFr: z.string().trim().max(20000),
  imageUrl: z.string().trim().max(500),
  seoTitleTr: z.string().trim().max(120),
  seoDescriptionTr: z.string().trim().max(320),
  seoTitleFr: z.string().trim().max(120),
  seoDescriptionFr: z.string().trim().max(320),
